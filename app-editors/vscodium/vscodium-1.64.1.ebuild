...
SRC_URI="
	amd64? ( https://fyn-github-mirror.qwe7951384261.workers.dev/https://github.com/VSCodium/${PN}/releases/download/${PV}/VSCodium-linux-x64-${PV}.tar.gz -> ${P}-amd64.tar.gz )
	arm? ( https://fyn-github-mirror.qwe7951384261.workers.dev/https://github.com/VSCodium/${PN}/releases/download/${PV}/VSCodium-linux-armhf-${PV}.tar.gz -> ${P}-arm.tar.gz )
	arm64? ( https://fyn-github-mirror.qwe7951384261.workers.dev/https://github.com/VSCodium/${PN}/releases/download/${PV}/VSCodium-linux-arm64-${PV}.tar.gz -> ${P}-arm64.tar.gz )
"
...
src_install() {
	...
	fperms -R +x /opt/${PN}/resources/app/node_modules.asar.unpacked/
