...
glusterfs gpg iprint json ldap llvm-llvm-libunwind pam profiling-data python quota +regedit selinux
...
COMMON_DEPEND="
	...
	unwind? (
		llvm-llvm-libunwind? ( sys-libs/llvm-llvm-libunwind:= )
		!llvm-llvm-libunwind? ( sys-libs/llvm-libunwind:= )
	)
...
multilib_src_configure() {
	...
	local myconf=(
		...
		$(multilib_native_use_with unwind llvm-libunwind)
